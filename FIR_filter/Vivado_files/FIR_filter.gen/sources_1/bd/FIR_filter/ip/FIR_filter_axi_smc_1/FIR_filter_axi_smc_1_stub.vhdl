...
-- Date        : Wed Apr  2 09:16:22 2025
-- Host        : HPLPF4WRX41 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub
--               c:/Repositories/PYNQ-Z2/FIR_filter/FIR_filter.gen/sources_1/bd/FIR_filter/ip/FIR_filter_axi_smc_1/FIR_filter_axi_smc_1_stub.vhdl
-- Design      : FIR_filter_axi_smc_1
...
entity FIR_filter_axi_smc_1 is
  Port ( 
    aclk : in STD_LOGIC;
  ...
  attribute CHECK_LICENSE_TYPE of FIR_filter_axi_smc_1 : entity is "FIR_filter_axi_smc_1,bd_ac73,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of FIR_filter_axi_smc_1 : entity is "FIR_filter_axi_smc_1,bd_ac73,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=25,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of FIR_filter_axi_smc_1 : entity is "yes";
end FIR_filter_axi_smc_1;

architecture stub of FIR_filter_axi_smc_1 is
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN FIR_filter_processing_system7_0_0_FCLK_CLK0, ASSOCIATED_BUSIF M00_AXI:S00_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN s_sc_aclken";
  ...
  attribute X_CORE_INFO of stub : architecture is "bd_ac73,Vivado 2024.2";
begin
end;
