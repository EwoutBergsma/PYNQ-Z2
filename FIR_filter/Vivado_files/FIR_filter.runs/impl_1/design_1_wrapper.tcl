namespace eval ::optrace {
  variable script "C:/Repositories/PYNQ-Z2/FIR_filter/Vivado_files/FIR_filter.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/Repositories/PYNQ-Z2/FIR_filter/Vivado_files/FIR_filter.cache/wt [current_project]
  set_property parent.project_path C:/Repositories/PYNQ-Z2/FIR_filter/Vivado_files/FIR_filter.xpr [current_project]
  set_property ip_output_repo C:/Repositories/PYNQ-Z2/FIR_filter/Vivado_files/FIR_filter.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/Repositories/PYNQ-Z2/FIR_filter/Vivado_files/FIR_filter.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files C:/Repositories/PYNQ-Z2/FIR_filter/Vivado_files/FIR_filter.srcs/sources_1/bd/design_1/design_1.bd
