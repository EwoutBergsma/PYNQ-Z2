...
HD_PWD='C:/Repositories/PYNQ-Z2/FIR_filter/FIR_filter.runs/FIR_filter_axi_mem_intercon_imp_auto_us_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_filter_axi_mem_intercon_imp_auto_us_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIR_filter_axi_mem_intercon_imp_auto_us_0.tcl
