...
HD_PWD='C:/Repositories/PYNQ-Z2/FIR_filter/FIR_filter.runs/FIR_filter_rst_ps7_0_100M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_filter_rst_ps7_0_100M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIR_filter_rst_ps7_0_100M_1.tcl
